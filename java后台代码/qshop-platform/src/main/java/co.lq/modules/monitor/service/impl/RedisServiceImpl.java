...
import co.lq.modules.monitor.domain.vo.RedisVo;
import co.lq.modules.monitor.service.RedisService;
    ...
    public Page<RedisVo> findByKey(String key, Pageable pageable) {
        ...
        for (Object s : redisTemplate.keys(key)) {
            ...
            if (s.toString().indexOf("role::loadPermissionByUser") != -1
                    ...
                    || s.toString().indexOf("wxpay") != -1 || s.toString().indexOf("site_url") != -1) {
                continue;
            }
