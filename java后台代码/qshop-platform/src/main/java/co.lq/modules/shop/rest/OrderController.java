...
public class OrderController {
    ...
    public OrderController(StoreOrderService storeOrderService, StoreOrderStatusService storeOrderStatusService,
                           ...
                           StorePinkService storePinkService, ExpressProperties properties) {
    ...
    @AnonymousAccess
    public ResponseEntity getChart(@Param("time") Date time, @Param("storeId") Long storeId) {
        return new ResponseEntity<>(storeOrderService.chartCount(time, storeId), HttpStatus.OK);
    }
    ...
    public ResponseEntity express(@RequestBody ExpressParam expressInfoDo) {
        if (expressInfoDo.getLogisticCode() == null || expressInfoDo.getShipperCode() == null) {
