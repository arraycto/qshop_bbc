...
public class CodeGenerator {
    ...
    private static final String   DRIVER_URL                  = "jdbc:mysql://localhost:3306/qshop_bbc?autoReconnect=true&useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8";

    private static final String   PARENT_PACKAGE              = "co.lq";
    ...
    private static final String   SUPER_CONTROLLER            = PARENT_PACKAGE
    ...
    private static final String   PROJECT_PACKAGE_PATH        = "co/lq";

    private static final String   PARENT_PACKAGE2             = "co.lq.modules";

    // ############################ 配置部分 start ############################
    // 模块名称
    private static final String   MODULE_NAME                 = "shop";
    // 作者
    private static final String   AUTHOR                      = "billy";
    // 生成的表名称
    private static final String   TABLE_NAME                  = "company_address";                                                                                                       // 主键数据库列名称
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/qshop-api/src/main/java");
        gc.setAuthor(AUTHOR);
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                // 查询参数包路径
                map.put("queryParamPath", PARENT_PACKAGE2 + StringPool.DOT + pc.getModuleName() + ".web.param."
                        + underlineToPascal(TABLE_NAME) + "QueryParam");
                // 查询参数共公包路径
                ...
                // 响应结果包路径
                map.put("queryVoPath", PARENT_PACKAGE2 + StringPool.DOT + pc.getModuleName() + ".web.vo."
                        + underlineToPascal(TABLE_NAME) + "QueryVo");
                // 实体对象名称
                ...
                // 导入排序查询参数类
                map.put("orderQueryParamPath",
                        PARENT_PACKAGE + StringPool.DOT + "common.web.param." + "OrderQueryParam");
                // 代码生成策略
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/qshop-api/src/main/resources/mapper/" + pc.getModuleName() + "/"
        ...
        focList.add(new FileOutConfig("/templates/queryParam.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/qshop-api/src/main/java/" + PROJECT_PACKAGE_PATH + "/modules/"
                        + pc.getModuleName() + "/web/param/" + tableInfo.getEntityName() + "QueryParam"
                        + StringPool.DOT_JAVA;
            }
        });
        ...
        focList.add(new FileOutConfig("/templates/queryVo.java.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/qshop-api/src/main/java/" + PROJECT_PACKAGE_PATH + "/modules/"
                        + pc.getModuleName() + "/web/vo/" + tableInfo.getEntityName() + "QueryVo" + StringPool.DOT_JAVA;
            }
        });
        ...
        /**
         * 注意，根据实际情况，进行设置 当表名称的前缀和模块名称一样时，会去掉表的前缀
