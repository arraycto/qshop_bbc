  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','storeGiftsCategory:edit','storeGiftsCategory:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudStoreGiftsCategory from '@/api/storeGiftsCategory'
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '赠品分类', url: 'api/storeGiftsCategory', sort: 'id,desc', crudMethod: { ...crudStoreGiftsCategory }})
const defaultForm = { id: null, name: null, icon: null, showStatus: null, sort: null, storeId: null, addTime: null, modifyTime: null, deleted: null }
export default {
  name: 'StoreGiftsCategory',
  components: { pagination, crudOperation, rrOperation, udOperation },
  mixins: [presenter(defaultCrud), header(), form(defaultForm), crud()],
  data() {
    return {
      permission: {
        add: ['admin', 'storeGiftsCategory:add'],
        edit: ['admin', 'storeGiftsCategory:edit'],
        del: ['admin', 'storeGiftsCategory:del']
      },
      rules: {
        addTime: [
