<template>
  <el-dialog :append-to-body="true" :close-on-click-modal="false" :before-close="cancel" :visible.sync="dialog" :title="isAdd ? '新增' : '订单核销'" width="560px">
...
import { add, editT, get } from '@/api/storeOrder'
export default {
  props: {
    isAdd: {
      type: Boolean,
