  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="columns.visible('brandName')" prop="brandName" label="brandName" />
        ...
        <el-table-column v-permission="['admin','homeBrand:edit','homeBrand:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudHomeBrand from '@/api/homeBrand'
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '首页推荐品牌表', url: 'api/homeBrand', sort: 'id,desc', crudMethod: { ...crudHomeBrand }})
const defaultForm = { id: null, brandId: null, brandName: null, recommendStatus: null, sort: null, storeId: null, addTime: null, modifyTime: null, deleted: null }
export default {
  name: 'HomeBrand',
  ...
  data() {
    return {
      permission: {
        add: ['admin', 'homeBrand:add'],
        edit: ['admin', 'homeBrand:edit'],
        del: ['admin', 'homeBrand:del']
      },
      rules: {
        addTime: [
