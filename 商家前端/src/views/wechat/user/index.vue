  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <div style="display: inline-block;margin: 0px 2px;">
        <el-button
          v-permission="['admin','WECHATUSER_ALL','WECHATUSER_CREATE']"
          class="filter-item"
          size="mini"
          type="primary"
          icon="el-icon-plus"
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['admin','WECHATUSER_ALL','WECHATUSER_EDIT','WECHATUSER_DELETE'])" label="操作" width="150px" align="center">
        <template slot-scope="scope">
          <el-button v-permission="['admin','WECHATUSER_ALL','WECHATUSER_EDIT']" size="mini" type="primary" icon="el-icon-edit" @click="edit(scope.row)" />
          <el-popover
            :ref="scope.row.uid"
            v-permission="['admin','WECHATUSER_ALL','WECHATUSER_DELETE']"
            placement="top"
            width="180"
          >
            <p>确定删除本条数据吗？</p>
...
import { del } from '@/api/wechatUser'
