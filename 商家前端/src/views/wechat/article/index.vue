<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['admin','ARTICLE_ALL','ARTICLE_EDIT','ARTICLE_DELETE'])" label="操作" width="180px" align="center">
        <template slot-scope="scope">
          <el-button v-permission="['admin','ARTICLE_ALL','ARTICLE_EDIT']" size="mini" type="primary" icon="el-icon-edit" @click="edit(scope.row)" />
          <el-popover
            :ref="scope.row.id"
...
import { del, publish } from '@/api/article'
