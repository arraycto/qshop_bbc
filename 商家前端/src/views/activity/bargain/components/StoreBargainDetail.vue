  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="helpCategory" :rules="rules" ref="helpCategoryFrom" label-width="150px">
      ...
      <el-form-item label="砍价简介">
        <el-input v-model="helpCategory.info" style="width: 500px;" rows="5" type="textarea" />
      </el-form-item>
      ...
      <el-form-item label="允许砍到最低价">
        <el-input-number v-model="helpCategory.minPrice" />
      </el-form-item>
      <el-form-item label="限购">
        <el-input-number v-model="helpCategory.num" />
      </el-form-item>
      <el-form-item label="单次砍最高价">
        <el-input-number v-model="helpCategory.bargainMaxPrice" />
      </el-form-item>
      <el-form-item label="单次砍最低价">
        <el-input-number v-model="helpCategory.bargainMinPrice" />
      </el-form-item>
      <el-form-item label="用户每次砍价的次数">
        <el-input-number v-model="helpCategory.bargainNum" />
      </el-form-item>
      <el-form-item label="反多少积分">
        <el-input-number v-model="helpCategory.giveIntegral" />
      </el-form-item>
      <el-form-item label="砍价状态">
        <el-radio v-model="helpCategory.status" :label="1">到砍价时间自动开启</el-radio>
        <el-radio v-model="helpCategory.status" :label="0" style="width: 110px;">到砍价时间不自动开启</el-radio>
      </el-form-item>
      ...
      <el-form-item v-if="helpCategory.isPostage ===0" label="邮费">
        <el-input-number v-model="helpCategory.postage" />
      </el-form-item>
      <el-form-item label="砍价规则">
        <editor v-model="helpCategory.rule" />
      </el-form-item>
...
<script>
  import {add as createHelpCategory, getBargains as getHelpCategory, edit as updateHelpCategory} from '@/api/storeBargain'
