  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <div style="display: inline-block;margin: 0px 2px;">
        <el-button
          v-permission="['admin','STORECOUPON_ALL','STORECOUPON_CREATE']"
          class="filter-item"
          size="mini"
          type="primary"
          icon="el-icon-plus"
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['admin','STORECOUPON_ALL','STORECOUPON_EDIT','STORECOUPON_DELETE'])" width="200" label="操作" align="center">
        <template slot-scope="scope">
          <el-button
            v-permission="['admin','STORECOUPON_ALL','STORECOUPON_EDIT']"
            size="mini"
            type="primary"
          ...
          <el-dropdown size="mini" split-button type="primary" trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-popover
                  :ref="scope.row.id"
                  v-permission="['admin','STORECOUPON_ALL','STORECOUPON_DELETE']"
                  placement="top"
                  width="180"
                >
                  <p>确定删除本条数据吗？</p>
...
import { del } from '@/api/storeCoupon'
