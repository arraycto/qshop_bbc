<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['admin','STORECOUPONISSUE_ALL','STORECOUPONISSUE_EDIT','STORECOUPONISSUE_DELETE'])" label="操作" width="150px" align="center">
        <template slot-scope="scope">
          <el-button v-permission="['admin','STORECOUPONISSUE_ALL','STORECOUPONISSUE_EDIT']" size="mini" type="primary" icon="el-icon-edit" @click="edit(scope.row)" />
          <el-popover
            :ref="scope.row.id"
            v-permission="['admin','STORECOUPONISSUE_ALL','STORECOUPONISSUE_DELETE']"
            placement="top"
            width="180"
          >
            <p>确定删除本条数据吗？</p>
