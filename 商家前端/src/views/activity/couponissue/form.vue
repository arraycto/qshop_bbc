<template>
  <el-dialog :append-to-body="true" :close-on-click-modal="false" :before-close="cancel" :visible.sync="dialog" :title="isAdd ? '新增' : '发布优惠券'" width="560px">
...
<script>
import { add, edit } from '@/api/storeCouponIssue'
export default {
  props: {
    isAdd: {
      type: Boolean,
