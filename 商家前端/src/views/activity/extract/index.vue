<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['admin','USEREXTRACT_ALL','USEREXTRACT_EDIT','USEREXTRACT_DELETE'])" label="操作" width="150px" align="center">
        <template slot-scope="scope">
          <el-button
            v-permission="['admin','USEREXTRACT_ALL','USEREXTRACT_EDIT']"
            size="mini"
            type="primary"
            @click="edit(scope.row)"
          >操作</el-button>
          <!--<el-popover-->
          <!--v-permission="['admin','USEREXTRACT_ALL','USEREXTRACT_DELETE']"-->
          <!--:ref="scope.row.id"-->
          <!--placement="top"-->
          <!--width="180">-->
          <!--<p>确定删除本条数据吗？</p>-->
...
import { del } from '@/api/userExtract'
