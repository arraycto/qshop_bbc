<template>
  <el-dialog :append-to-body="true" :close-on-click-modal="false" :before-close="cancel" :visible.sync="dialog" :title="isAdd ? '新增' : '余额修改'" width="560px">
...
<script>
import { add, edit, editp } from '@/api/user'
export default {
  props: {
    isAdd: {
      type: Boolean,
