    ...
    <el-dialog title="选择商品" :visible.sync="selectDialogVisible" width="50%">
      ...
      <div class="pagination-container">
        <el-pagination
          ...
          :current-page="dialogData.listQuery.page"
...
<script>
  import {getHomeReProductList,edit,del,add} from '@/api/homeRecommendProduct';
    ...
    methods: {
      ...
      handleBatchOperate(){
        ...
        if (this.operateType === 0) {
          ...
          //删除
          this.deleteProduct(this.multipleSelection[0].id);
        }else {
          this.$message({
            message: '请选择批量操作类型',
            type: 'warning',
      ...
      handleSelectDialogConfirm(){
        ...
        this.$confirm('使用要进行添加操作?', '提示', {
          ...
          add(selectProducts).then(response=>{
      ...
      getList() {
        ...
        getHomeReProductList(this.listQuery).then(response => {
