<template>
  <el-dialog :append-to-body="true" :close-on-click-modal="false" :before-close="cancel" :visible.sync="dialog" :title="title" width="900px">
    <el-form v-show="hidden == false" ref="form" :model="form" :inline="true" :rules="rules" label-width="100px">
    ...
    <el-form v-show="hidden == true" ref="form" :model="form" :rules="rules" label-width="100px">
      <el-form-item label="规则名称">
        <el-row :gutter="10">
          <el-col
...
import { add, edit, isFormatAttr, setAttr, clearAttr, getAttr } from '@/api/storeProduct'
