  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','cmsSubjectProductRelation:edit','cmsSubjectProductRelation:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudCmsSubjectProductRelation from '@/api/cmsSubjectProductRelation'
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '专题商品关系表', url: 'api/cmsSubjectProductRelation', sort: 'id,desc', crudMethod: { ...crudCmsSubjectProductRelation }})
const defaultForm = { id: null, subjectId: null, productId: null, storeId: null, addTime: null, modifyTime: null, deleted: null }
export default {
  ...
  data() {
    return {
      permission: {
        add: ['admin', 'cmsSubjectProductRelation:add'],
        edit: ['admin', 'cmsSubjectProductRelation:edit'],
        del: ['admin', 'cmsSubjectProductRelation:del']
      },
      rules: {
        addTime: [
