...
<script>
  ...
  import {getReturnApplyList,del} from '@/api/orderReturnApply';
  ...
  export default {
    ...
    methods:{
      ...
      handleViewDetail(index,row){
        this.$router.push({path:'/order/returnDetail',query:{id:row.id, addressId:row.addressId}})
      },
      handleBatchOperate(){
      ...
      getReturnApplyList(){
        ...
        getReturnApplyList(this.listQuery).then(response => {
